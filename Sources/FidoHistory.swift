...
public class FidoHistory: FINporter {
    public override var name: String { "Fido History" }
    public override var id: String { "fido_history" }
    public override var description: String { "Detect and decode account history export files from Fidelity, for sale and purchase info." }
